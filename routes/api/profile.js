...
// split method is used for converting a string into an array trim is used for re moving the spaces
  ...
  if(linkedin) profileFields.social.linkedin = linkedin;
    //  whenever  using mongoose method use await infront 
  try{
...
try {
  ...
  // unshift is same as push where push is used for adding elements at the end where unshift adds 
